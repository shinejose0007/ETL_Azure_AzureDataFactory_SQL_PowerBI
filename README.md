...
│ ├─ data_sample_sales.csv # synthetic raw transactional data
│ ├─ synapse_load.csv # output of ETL (full transactions) - generated by etl.py
│ └─ transformed_daily_kpis.csv # aggregated KPIs - generated by etl.py
├─ etl.py # local ETL script (Pandas)
├─ create_table.sql # SQL DDL for Azure SQL / Synapse tables
├─ adf/ # Azure Data Factory templates
│ ├─ pipeline_filled.json
│ ├─ data_factory_pipeline_example.json
│ ├─ LinkedService_BlobStorage_filled.json
│ └─ LinkedService_Synapse_filled.json
├─ powerbi/ # Power BI guidance & templates
│ ├─ pbix_readme.txt
│ ├─ dax_measures.md
│ └─ powerbi_page_mockups.md
├─ README_GITHUB.md # short repo README for GitHub root
├─ README_FULL.md # detailed guide (this file)
├─ LICENSE
└─ requirements.txt
